...
static hid_device *readcard_handle;
static int Com_Id;
static int Hw_Versions_Number;
static int Souser_Versions_Number;
...
int HID_API_EXPORT HID_API_CALL ReadBlockData(unsigned char *sn,    //	硬卡號
...
int HID_API_EXPORT HID_API_CALL WriteBlockData(unsigned char *sn,             //	硬卡号
unsigned char blkNo,           //	要读取的块号
unsigned char keyType,         //	密碼类型(KeyA,KeyB)
unsigned char *keyValue,       //	密碼内容
unsigned char *pdata)
...
int HID_API_EXPORT HID_API_CALL ReadSectorData(unsigned char *sn,    //	硬卡号
...
int HID_API_EXPORT HID_API_CALL WriteSectorData(unsigned char *sn,             //	硬卡号
unsigned char secNo,           //	要读取的扇区号
unsigned char keyType,         //	密碼类型(KeyA,KeyB)
unsigned char *keyValue,       //	密碼内容
unsigned char *pdata)
...
unsigned long address,           //	要读取的块号
unsigned short datasize,         //	密碼类型(KeyA,KeyB)
unsigned char *pdata)
{
